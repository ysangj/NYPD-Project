...
public class CollisionInfo {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		for(int z=0;z<20;z++){
			...
			fin.close();
			read=read+elapsedTime1;
			compute=compute+elapsedTime2;
			
		}

		System.out.println("\n\n============================================\n");
		System.out.printf("Average Reading and storing data: %,15d nanoseconds\n", (read/20));
		System.out.printf("Average Computation of results  : %,15d nanoseconds\n", (compute/20));
